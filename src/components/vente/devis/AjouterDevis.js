        ...
        onSubmitMessage(ttc,th,tva){
          ...
          onSubmit = (e) => {
            ...
            const devis = {
                ...
                client: this.state.nom,
              
              }
              console.log(devis);
              
           axios.post('http://localhost:3001/Devis/ajouter', devis)
              .then(res => console.log(res.data));
                    ...
                    <div className="row mb-2">
                        ...
                        <div className="col-sm-11">
                            <ol className="breadcrumb float-sm-right">
                                <li className="breadcrumb-item"><a href="/devislist">Devis</a></li>
                                <li className="breadcrumb-item"><a href="/ajouterdevis">Ajouter devis</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
    ...
    return(
        ...
        <div className={styles.addresses}>
            ...
            <div className={styles.value}>
                ...
                <div className={styles.label} >
                <label className="required">Date fin validation :</label></div>
