...
export const add = facture => {
  
    return axios
      .post('http://localhost:3001/Facture/ajouter', {
        DateDoc: facture.DateDoc,
        DateFinDoc: facture.DateFinDoc,
        Note: facture.Note,
  ...
  currency = 'USD'
    constructor(props){
        ...
        this.state = {
          ...
          totalTVA:0,
          totalTTC:0,
          DateFinDoc:moment(new Date(),'YYYY-MM-DD').format(),
